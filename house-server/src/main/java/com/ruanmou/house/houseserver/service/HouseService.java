...
import com.ruanmou.house.houseserver.domain.*;
import com.ruanmou.house.houseserver.mapper.CityMapper;
import com.ruanmou.house.houseserver.mapper.HouseMapper;
import com.ruanmou.house.houseserver.model.LimitOffset;
import com.ruanmou.house.houseserver.utils.BeanHelper;
...
//    @Value("${qiniu.cdn.prefix:}")
    ...
    public void addUserMsg(UserMsg userMsg) {
        ...
        mailService.sendMail("来自用户" + userMsg.getEmail(), userMsg.getMsg(), userMsg.getEmail());
    }
