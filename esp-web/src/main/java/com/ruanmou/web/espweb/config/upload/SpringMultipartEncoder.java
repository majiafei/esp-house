package com.ruanmou.web.espweb.config.upload;
...
public class SpringMultipartEncoder implements Encoder {
    ...
    private static final Class MULTIPART_CLAZZ = MultipartFile.class;
    private static final String FILES_KEY="multipartFiles";
    private static final String FILE_KEY="multipartFile";
    ...
    private void encodeMultipartFormRequest(Object object, RequestTemplate template) throws EncodeException {
        ...
        if (isMultipartFile(object)) {
            ...
            encodeMultipartFile(map, FILE_KEY, multipartFile);
            // 多文件上传
     ...
     * @return
     */
    private void encodeMultipartFile(LinkedMultiValueMap<String, Object> map, String name, MultipartFile file) {
    ...
    private static boolean isFormRequest(Type type) {
        ...
        return MULTIPART_CLAZZ.equals(type) || MULTIPART_ARRAY_CLAZZ.equals(type);
    }
