package com.ruanmou.web.espweb.controller.user;
...
import com.ruanmou.web.espweb.vo.AgencyVO;
...
public class UserController {
    ...
    public String accountsSubmitToQiniu(HttpServletRequest request, UserVO account,
        ...
        if (StringUtils.isBlank(account.getEmail())) {
            ...
            ApiResponse apiResponse = accountService.intiRegPage();
    ...
    public String loginSubmit(UserVO user, RedirectAttributes model, HttpServletResponse response, HttpSession session) {
